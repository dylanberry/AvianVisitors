...
AGENTS.md               # agent/operator notes for the Toronto Pi deployment
```

Everything outside `avian/` and `frame/` is upstream BirdNET-Pi.

For the live Toronto deployment notes — environment, conventions, architecture, and open work — see [`AGENTS.md`](AGENTS.md).
